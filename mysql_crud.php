...
class Database{
	...
	private $db_name = "Estacionamento";	// Change as required
	...
	public function testaNumero($numero) {
        if ($numero == 0) {
            $retorno = "Numero neutro";
        } elseif ($numero > 0) {
            $retorno = "Numero positivo";
        } else {
            $retorno = "Numero negativo";
        }
        return $retorno;
    }
} 
